...
class OutputHomeModel {
    ...
    val description =
        "GeoCell is a web application designed to assist search and rescue teams in locating mobile devices connected to cellular networks by identifying their Cell Global Identity (CGI) registration."
